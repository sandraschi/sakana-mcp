...
4. Start the server:
   ...
   uv run python -m sakana_mcp.server

   # HTTP mode (for web dashboard)
   uv run uvicorn sakana_mcp.server:app --port 10863
   ```
...
5. Open `http://localhost:10863` or the frontend URL.
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/sakana-mcp/issues) |
